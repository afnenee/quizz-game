                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <form wire:submit.prevent="save">
                            <div class="mt-4">
                                ...
                                <select id="category" wire:model="category_id" class="block mt-1 w-full">
                            ...
                            <div id="questions" class="block mt-1 w-full">
                                @foreach ($questions as $id => $text)
                                    <label class="flex items-center">
                                        <input type="checkbox" value="{{ $id }}" wire:model.defer="questionsSelected" class="mr-2">
                                        {{ $text }}
                                    </label>
                                @endforeach
                            </div>
